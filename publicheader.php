			...
			<div class="banner-top w3layouts">
				<div class="container">
					<ul class="agile_top_section">
						...
						<li><a class="sign" href="#" data-toggle="modal" data-target="#myModal2"><i class="fa fa-sign-in" aria-hidden="true"></i>  Login</a>	

						<a class="sign" href="customer_registration.php"> <i class="fa fa-sign-in" aria-hidden="true"></i>Register</a></li>

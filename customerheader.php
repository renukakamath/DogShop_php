					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<div class="w3menu navbar-left">
							<ul class="nav navbar">
								...
								<li><a href="customer_searchproduct.php">Search Product</a></li>



                                         <?php 

                                        $q="select * from tbl_cartmaster where status='pending' and cust_id='$cid'";
                                        $res=select($q);
                                        if (sizeof($res)>0) {?>
                                        	<li><a href="customer_buy.php">Make Order</a></li>
                                       <?php }
										...
										<li><a href="customer_myorders.php">My Orders</a></li>
